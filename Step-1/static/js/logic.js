//api from Mapbox
var apiKey = "pk.eyJ1IjoiZmlyZXByb29mc29ja3MiLCJhIjoiY2psd2FpbzdpMTRhczNwcGUxb2phcnRuMCJ9.l4EjUexxcYe9PEifJy2NrA";

//define the map layer
eartquakeColormap=L.tileLayer("https://api.tiles.mapbox.com/v4/{id}/{z}/{x}/{y}.png?access_token={accessToken}", {
  attribution: "Map data &copy; <a href=\"https://www.openstreetmap.org/\">OpenStreetMap</a> contributors, <a href=\"https://creativecommons.org/licenses/by-sa/2.0/\">CC-BB-SA</a>, Imagery © <a href=\"https://www.mapbox.com/\">Mapbox</a>",
  maxZoom: 18,
...
//Get style pointer on for the earthquake point on the map, showing the magnitude in color indicator and radius
  ...
  L.geoJson(data, {
    ...
    onEachFeature: function(quakePoint, layer) {
      layer.bindPopup("Magnitude: " + quakePoint.properties.mag + "<br>Location: " + quakePoint.properties.place);
    }
  }).addTo(map_object);
